...
追加されるアイテム
    ...
    Laser B1ade / レーザーブレード
        ...
        攻撃力：　5（❤×2.5）
        攻撃速度：　2.8
        エンチャント：　エンチャントテーブルで剣タイプのエンチャントが可能。金床エンチャントも可能
    ...
    Laser Blade / レーザーブレイド    （強い）
        ...
        攻撃力：　10（❤×5）
        攻撃速度：　4
        エンチャント：　アンデッド特効（Smite）V をクラフト時に自動付与。金床エンチャントも可能
        刃の色：　赤
    ...
    Laser Blade / レーザーブレイド    （もっと強い）
        ...
        攻撃力：　14（❤×7）
        攻撃速度：　4
        エンチャント：　アンデッド特効（Smite）X、範囲ダメージ増加 (Sweeping Edge) III をクラフト時に自動付与。金床エンチャントも可能
        刃の色：　赤
