...
追加されるアイテム
    ...
    Laser Blade / レーザーブレイド    (Weaker 弱い)
        ...
        レッドストーンの力でイオン添加ガラスを励起させ発生した光をダイヤモンドのレンズに通してレッドストーンの力で棒状にしているという。
        なお、本来は切削用の工具であった。

        ちなみにエンチャントされていないレーザーブレイドの表示名を金床で「おたから」または「GIFT」に変更すると……
    ...
    Laser Blade / レーザーブレイド    (Stronger 強い)
        ...
        攻撃力： 10 (❤×5)
        攻撃速度： 4
        エンチャント： Smite (アンデッド特効) V をクラフト時に自動付与。金床でエンチャントの合成が可能
        刃の色： 赤
