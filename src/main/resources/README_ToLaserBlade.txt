...
追加されるアイテム
    ...
    Laser Blade / レーザーブレイド    (Class 2)
        ...
        レーザーの媒質をイオン添加ガラスからグロウストーンに変更して、出力を強化したレーザーブレイド。
    ...
    Laser Blade / レーザーブレイド    (Class 4)
        ...
        金床でMobの頭と合成すると、攻撃力をさらに上げることができる。(Class 4+)
...
リソースパックによるモデルの差し替え
    ...
    ToLaserBladeでは以下に示す特定のOBJグループ（gステートメントで指定）のみがゲーム内で描画される。
        ...
        Hilt_bright     ゲーム内の陰影や環境光の影響を受けず、常に明るく描画されるパーツ
